...
public class CustomModelBakery {
	...
	private final Map<ResourceLocation, ResourceLocation> rsourceLocationMap = Maps.newIdentityHashMap();
	...
	public ResourceLocation getResourceLocation(ResourceLocation location) {
	...
	protected void loadBlocks() {
		...
		for (Block block : Block.REGISTRY) {
			for (final ResourceLocation resourcelocation : blockstatemapper.getBlockstateLocations(block)) {
				try {
					rsourceLocationMap.put(block.getRegistryName(), resourcelocation);
		...
		ITextureMapPopulator itexturemappopulator = new ITextureMapPopulator() {
			public void registerSprites(TextureMap textureMapIn) {
				for (ResourceLocation resourcelocation : set) {
					...
					CustomModelBakery.this.sprites.put(resourcelocation, textureatlassprite);
				}
			}
		};
